...
.EXAMPLE
    ./scripts/dev-tools/load-openai-key.ps1 -ItemName "Lexile OpenAI Key"

.EXAMPLE
    ./scripts/dev-tools/load-openai-key.ps1 -ItemName "Lexile OpenAI Key" -UsePasswordField -EnvVar "OPENAI_API_KEY"
#>
[CmdletBinding()]
param(
    [Parameter()]
