...
- A “context file” containing (commonly):
  ...
  - issues to autoclose (verified/pending) when `gh` is available
   - sometimes embedded feature-doc excerpts (spec/plan/user-story) to explain “why”
   - an enumerated list of Additional Context files you are allowed to reference
...
2. **Why**
   ...
   - Prefer embedded feature-doc excerpts (spec/plan/user-story) and PR Intent fields; do not speculate beyond provided sources.
