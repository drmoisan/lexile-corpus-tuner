...
- Launched via: `python -m scripts.production.gutenberg_query_builder_ui`
...
```python
# Import and launch
from scripts.production.gutenberg_query_builder_ui import main
main()

# Use data models programmatically
from scripts.production.gutenberg_query_builder_ui import (
...
- [x] Module structure refactored for maintainability:
  ...
  - [x] Executable via `python -m scripts.production.gutenberg_query_builder_ui`
