...
- **Status:** Superseded
- **Outcome:** Development proceeded under the split workflow; CK-12 ingestion is PDF-based. No PDF documents found on endpoint.
- **Root Cause:** Incorrect assumption that CK-12 FlexBooks provide downloadable PDF exports; HAR capture (artifacts/www.ck12.org.har) shows only reader JSON/HTML endpoints and assets and no .pdf URLs.
- Issue: #73
- Owner: drmoisan
