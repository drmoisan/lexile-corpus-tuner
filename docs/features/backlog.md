...
| issue #15 | 2025-12-05 | lexile-refactor-pipeline-structure       | Refactor pipeline structure to improve maintainability and alignment            | agent  | Issue #15 (child of #10) |
| potential | 2025-12-04 | gutenberg-query-builder-ui               | Visual query builder GUI using Tkinter for constructing complex queries         | agent  | Promote to GitHub issue  |
| potential | 2025-12-08 | fix-all-ruff-black-sequencing            | fix-all reruns Ruff to confirm fixes, then reruns Black before Pytest when either tool applies changes | agent  | Promote to GitHub issue  |
...
| issue #49 | 2025-12-17 | commit-message-process-automation        | Automate commit context collection, LLM drafting, and SCM input autofill via `/commit-message-generator` | user   | Issue #49                |
